...
function serialize_ChatMessagePrompt(arg) {
  if (!(arg instanceof messages_pb.ChatMessagePrompt)) {
    throw new Error('Expected argument of type ChatMessagePrompt');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ChatMessagePrompt(buffer_arg) {
  return messages_pb.ChatMessagePrompt.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_EditMapCommandMessage(arg) {
  if (!(arg instanceof messages_pb.EditMapCommandMessage)) {
    throw new Error('Expected argument of type EditMapCommandMessage');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_EditMapCommandMessage(buffer_arg) {
  return messages_pb.EditMapCommandMessage.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_EditMapCommandWithKeyMessage(arg) {
  if (!(arg instanceof messages_pb.EditMapCommandWithKeyMessage)) {
    throw new Error('Expected argument of type EditMapCommandWithKeyMessage');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_EditMapCommandWithKeyMessage(buffer_arg) {
...
function serialize_PingMessage(arg) {
  if (!(arg instanceof messages_pb.PingMessage)) {
    throw new Error('Expected argument of type PingMessage');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_PingMessage(buffer_arg) {
  return messages_pb.PingMessage.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_RoomsList(arg) {
  if (!(arg instanceof messages_pb.RoomsList)) {
    throw new Error('Expected argument of type RoomsList');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_RoomsList(buffer_arg) {
  return messages_pb.RoomsList.deserializeBinary(new Uint8Array(buffer_arg));
}
...
adminRoom: {
  ...
  sendChatMessagePrompt: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: messages_pb.ChatMessagePrompt,
    responseType: messages_pb.EmptyMessage,
    requestSerialize: serialize_ChatMessagePrompt,
    requestDeserialize: deserialize_ChatMessagePrompt,
    responseSerialize: serialize_EmptyMessage,
    responseDeserialize: deserialize_EmptyMessage,
  },
  getRooms: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: messages_pb.EmptyMessage,
    responseType: messages_pb.RoomsList,
    requestSerialize: serialize_EmptyMessage,
    requestDeserialize: deserialize_EmptyMessage,
    responseSerialize: serialize_RoomsList,
    responseDeserialize: deserialize_RoomsList,
  },
  ping: {
    path: '/RoomManager/ping',
    requestStream: false,
    responseStream: false,
    requestType: messages_pb.PingMessage,
    responseType: messages_pb.PingMessage,
    requestSerialize: serialize_PingMessage,
    requestDeserialize: deserialize_PingMessage,
    responseSerialize: serialize_PingMessage,
    responseDeserialize: deserialize_PingMessage,
  },
};
...
var MapStorageService = exports.MapStorageService = {
  ...
  handleEditMapCommandWithKeyMessage: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: messages_pb.EditMapCommandWithKeyMessage,
    responseType: messages_pb.EditMapCommandMessage,
    requestSerialize: serialize_EditMapCommandWithKeyMessage,
