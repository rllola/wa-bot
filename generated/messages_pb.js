 ...
 * @const
 */
proto.EditMapMessage.oneofGroups_ = [[1,2,3]];
 ...
 * @const
 */
proto.PusherToBackMessage.oneofGroups_ = [[1,2,4,5,6,7,10,12,13,14,15,16,17,18,19,21,22,23]];
...
proto.PusherToBackMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    querymessage: (f = msg.getQuerymessage()) && proto.QueryMessage.toObject(includeInstance, f),
    askpositionmessage: (f = msg.getAskpositionmessage()) && proto.AskPositionMessage.toObject(includeInstance, f),
    editmapcommandwithkeymessage: (f = msg.getEditmapcommandwithkeymessage()) && proto.EditMapCommandWithKeyMessage.toObject(includeInstance, f)
  };
...
proto.PusherToBackMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 22:
      ...
      break;
    case 23:
      var value = new proto.EditMapCommandWithKeyMessage;
      reader.readMessage(value,proto.EditMapCommandWithKeyMessage.deserializeBinaryFromReader);
      msg.setEditmapcommandwithkeymessage(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.PusherToBackMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getEditmapcommandwithkeymessage();
  if (f != null) {
    writer.writeMessage(
      23,
      f,
      proto.EditMapCommandWithKeyMessage.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional EditMapCommandWithKeyMessage editMapCommandWithKeyMessage = 23;
 * @return {?proto.EditMapCommandWithKeyMessage}
 */
proto.PusherToBackMessage.prototype.getEditmapcommandwithkeymessage = function() {
  return /** @type{?proto.EditMapCommandWithKeyMessage} */ (
    jspb.Message.getWrapperField(this, proto.EditMapCommandWithKeyMessage, 23));
};


/**
 * @param {?proto.EditMapCommandWithKeyMessage|undefined} value
 * @return {!proto.PusherToBackMessage} returns this
*/
proto.PusherToBackMessage.prototype.setEditmapcommandwithkeymessage = function(value) {
 ...
 * @return {!proto.PusherToBackMessage} returns this
 */
proto.PusherToBackMessage.prototype.clearEditmapcommandwithkeymessage = function() {
  return this.setEditmapcommandwithkeymessage(undefined);
};
 ...
 * @return {boolean}
 */
proto.PusherToBackMessage.prototype.hasEditmapcommandwithkeymessage = function() {
  return jspb.Message.getField(this, 23) != null;
};
